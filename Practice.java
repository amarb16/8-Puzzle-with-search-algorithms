...
public class Practice {
    ...
    public static void linkedListPractice() {
        ...
        System.out.println("x: " + x); // x is the same as x.toString() in the context of a println
        ...
        System.out.println("\nLooping again...");
        // This works too, but it's a bad idea. Why?
    ...
    public static void hashCodePractice() {
        ...
        System.out.println("\n----------");
        System.out.println("If the objects are .equals(), then the hashcodes should be the same.");
    }
    ...
    public static void hashSetPractice() {
        ...
        //it adds in x and y, then checks to see if x, y, z, and xTwin are in there
        //it will find x and y, but not z since it wasn't added, and it'll find xTwin because it has the same hashcode as x
    ...
    public static void priorityQueuePractice() {
        ...
        priorityQueue.offer(yPath); // distance 2
        priorityQueue.offer(xPath); // distance 7
        priorityQueue.offer(zPath); // distance 0
